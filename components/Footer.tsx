  ...
  return (
    <footer className="mt-32 border-t border-white/5">
      <div className="mx-auto max-w-6xl px-5 md:px-8 py-12 grid gap-10 md:grid-cols-[1.5fr_1fr_1fr]">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-ink-200">
            <li><Link href="/projects" className="hover:text-ink-50">Projects</Link></li>
            <li><Link href="/services" className="hover:text-ink-50">Services</Link></li>
            <li><Link href="/about" className="hover:text-ink-50">About</Link></li>
            <li><Link href="/resume" className="hover:text-ink-50">Resume</Link></li>
            <li><Link href="/blog" className="hover:text-ink-50">Notes</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-ink-200">
            <li>
              <a className="hover:text-ink-50" href={`mailto:${BIO.email}`}>
                {BIO.email}
              </a>
            </li>
            <li>
      ...
      <div className="border-t border-white/5">
        <div className="mx-auto max-w-6xl px-5 md:px-8 py-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 text-xs text-ink-400">
